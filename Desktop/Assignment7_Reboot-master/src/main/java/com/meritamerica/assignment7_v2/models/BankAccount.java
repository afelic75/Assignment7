...
import com.meritamerica.assignment7_v2.exceptions.ExceedsAvailableBalanceException;
import com.meritamerica.assignment7_v2.exceptions.NegativeAmountException;
...
public class BankAccount {
	...
	public boolean withdraw(double amount) throws ExceedsAvailableBalanceException, NegativeAmountException {
		if (amount > this.balance) {
			throw new ExceedsAvailableBalanceException("Exceeds Available Balance");
		}

		if (amount < 0) {
			throw new NegativeAmountException("Cannot withdraw neg amount");
		}
